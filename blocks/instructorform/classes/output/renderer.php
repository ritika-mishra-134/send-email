...
class renderer extends plugin_renderer_base {
     ...
     */
    public function render_instructorform(instructorform $instructorform) {
        global $USER, $DB;
        return $this->render_from_template('block_instructorform/instructorform',
            $instructorform->export_for_template($this));
    }
}
